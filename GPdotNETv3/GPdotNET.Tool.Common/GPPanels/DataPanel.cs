...
namespace GPdotNET.Tool.Common
{
   ...
   /// </summary>
    public partial class DataPanel : UserControl
    {
        ...
        private GPModelType _problemType= GPModelType.SymbolicRegression;
        ...
        private void btnLoadTrainig_Click(object sender, EventArgs e)
        {
            ...
            LoadTrainingData(data, GPModelType.SymbolicRegression);
        ...
        private void FillGridWithTransData(double[][] data)
        {
        ...
        /// </summary>
        /// <param name="data"></param>
        private void FillGridWithALOCData(double[][] data)
        {
        ...
        private void btnLoadTesting_Click(object sender, EventArgs e)
        {
            ...
            if (_problemType == GPModelType.SymbolicRegression || _problemType == GPModelType.SymbolicRegressionWithOptimization)
                LoadTestingData(data);
            else if (_problemType == GPModelType.TimeSeries)
                LoadSeriesData(data);
            else if (_problemType == GPModelType.TSP)
                LoadTrainingData(data, _problemType);
            else if (_problemType == GPModelType.ALOC)
                LoadTrainingData(data, _problemType);
            else if (_problemType == GPModelType.Transport)
                LoadTrainingData(data, _problemType);
            else
                LoadTestingData(data);
        ...
        public bool LoadTrainingData(double[][] data, GPModelType type )
        {
            if (data != null)
            {
                ...
                else if (type == GPModelType.ALOC)
                    FillGridWithALOCData(data);
                else if (type == GPModelType.Transport)
                    FillGridWithTransData(data);
                else
        ...
        {
            _problemType = type;
            if (_problemType == GPModelType.TimeSeries)
            {
			...
			else if(_problemType== GPModelType.SymbolicRegression || _problemType == GPModelType.SymbolicRegressionWithOptimization)
			{
            ...
            else if (_problemType == GPModelType.ALOC || _problemType == GPModelType.Transport)
            {
                groupBox5.Visible = false;
