	...
	#region ContextMenu
		...
		private void contextMenuStrip1_Opening( object sender, CancelEventArgs e )
		{
			...
			if ( _masterPane != null && menuStrip != null )
			{
				...
				if ( _isShowContextMenu )
				{
					...
					item.Name = "copy";
					item.Tag = "copy";
                    item.Text = "Copy";//_resourceManager.GetString( "copy" );
					...
					item.Name = "save_as";
					item.Tag = "save_as";
                    item.Text = "Save Image As...";//_resourceManager.GetString( "save_as" );
					...
					item.Tag = "page_setup";
                    item.Text = "Page Setup...";//_resourceManager.GetString( "page_setup" );
					...
					item.Name = "print";
					item.Tag = "print";
                    item.Text = "Print";//_resourceManager.GetString( "print" );
					...
					item.Name = "show_val";
					item.Tag = "show_val";
                    item.Text = "Show Point Values";//_resourceManager.GetString( "show_val" );
					...
					if ( pane == null || pane.ZoomStack.IsEmpty )
                        menuStr = "Un-Zoom";// _resourceManager.GetString( "unzoom" );
					else
					{
						switch ( pane.ZoomStack.Top.Type )
						{
							...
							case ZoomState.StateType.Pan:
								menuStr = "Un-Pan";// _resourceManager.GetString( "unzoom" );
								break;
							case ZoomState.StateType.Scroll:
								menuStr = "Un-Scroll";// _resourceManager.GetString( "unzoom" );
								break;
						}
					}
					...
					item.Name = "undo_all";
					item.Tag = "undo_all";
                    menuStr = "Undo All";//_resourceManager.GetString( "undo_all" );
					item.Text = menuStr;
                    ...
                    menuStr = "Set Scale to Default";// _resourceManager.GetString("set_default");
					item.Text = menuStr;
		...
		public void Copy( bool isShowMessage )
		{
			if ( _masterPane != null )
			{
				...
				if ( isShowMessage )
				{
                    string str = "Image copied to clipboard"; // _resourceManager.GetString("copied_to_clip");
