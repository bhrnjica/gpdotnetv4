...
namespace GPdotNETApp
{
    public partial class GPdotNetApp : Form
    {
        ...
        private void ShowNewForm(object sender, EventArgs e)
        {
            ...
            if (dlg.TimeSeries)
                childForm.Text = "New Time Series Model";
            else
                childForm.Text = "New Data Model";
            childForm.Show();
        }
        ...
        private void SaveAsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.Filter = "GPdotNET Files (*.gpx)|*.gpx|All Files (*.*)|*.*";
            ...
            if (this.MdiChildren.Length > 0)
            {
                ...
                //    Excel.Range oRng;
                    ...
                    try
                    {
                       ...
                       //GP Model formula
                        formula = "=" + GP_panel.functionSet.DecodeExpressionInExcellForm(GP_panel.GPBestHromosome.NodeValueEnumeratorDepthFirst.ToList(), GP_panel.terminalSet);
        ...
        private void GPdotNetApp_FormClosing(object sender, FormClosingEventArgs e)
        {
