...
*/
	...
	#region Constructors
		...
		public ZedGraphControl()
		{
            ...
            string titleStr = "Title";// _resourceManager.GetString("title_def");
            string xStr = "X Axis";// _resourceManager.GetString("x_title_def");
            string yStr = "Y Axis";//_resourceManager.GetString( "y_title_def" );
