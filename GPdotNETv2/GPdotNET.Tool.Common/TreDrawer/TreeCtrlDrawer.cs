...
namespace GPdotNET.Tool.Common
{
    ...
    public partial class TreeCtrlDrawer : Panel
    {
        ...
        NodeValue _funNodeValueCallback;
            ...
            : base()
        {
            ...
            nodeBrush = new SolidBrush(SystemColors.WindowFrame);
            font = new Font(new FontFamily("Arial"), 10f, FontStyle.Bold);
            frgFColor = new SolidBrush(Color.DarkOrange);
            frgTColor = new SolidBrush(Color.BlueViolet);
        }
        ...
        internal void AddNodeWithChildren(object value, int numAritry, TreeNodeDrawer treeNodeDrawer)
        {
            ...
            if (treeNodeDrawer == null)
                parentNode = AddNode(value, treeNodeDrawer);
            else
            {
        ...
        /// <returns></returns>
        public TreeNodeDrawer AddNode(object nodeValue, TreeNodeDrawer tnParent = null)
        {
        ...
        public void DrawTreeExpression(GPNode gpRoot,NodeValue funNodeValue)
        {
            Clear();
            ...
            treeCtrl = AddNode(gpRoot.value,null);
            ...
            while (dataTree.Count > 0)
            {
                ...
                if (node.children != null)
                    ...
                    {
                        var tn = AddNode(node.children[i].value, treeCtrl);
