...
{
    /// <summary>
    /// GPdotNET 4.0 implements the Fitness for Clasification problems.
    /// It calculates division between number of correctly predicted and total rows.
    /// </summary>

    public class AccuracyFitness : IFitnessFunction
    {
        #region IFitnessFunction Members
        public ColumnDataType m_ProblemType = ColumnDataType.Binary;
        public AccuracyFitness(ColumnDataType ptype)
        {
            m_ProblemType = ptype;
        }
