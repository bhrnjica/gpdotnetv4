...
{
    /// <summary>
    /// GPdotNET 4.0 implements the Mean Absolute Error (MAE) fitness function. The MAE fitness function of GPdotNET is, 
    /// as expected, based on the standard AverageValue absolute error, which, on its turn, is based on the absolute error.
    /// </summary>
    [Serializable]
