...
{
    /// <summary>
    /// GPdotNET 4.0 implements the Absolute Error With Selection Range (Absolute with SR) fitness function. 
    /// The Absolute with SR fitness function explores the idea of a selection range and a precision. 
    /// The selection range is used as a limit for selection to operate, above which the performance of 
    /// a program on a particular fitness case contributes nothing to its fitness. And the precision is 
    /// the limit for improvement, as it allows the fine-tuning of the evolved solutions as accurately as possible.
    /// </summary>
    [Serializable]
    public class AESRFitness:IFitnessFunction
    {
